...
async function Translate(promt) {
    try {
    ...
    try {
        const response = await client.completion({
            ...
            "messages": [
                {
                    role: "user",
                    content: `Переведи - ${promt} на английский и передай только перевод слова не надо указывать русский перевод, нужно только английское название`
                }
            ]
        });
